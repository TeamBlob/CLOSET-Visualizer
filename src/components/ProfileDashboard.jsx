...
export default function ProfileDashboard({ profileData, isAll }) {
    ...
    useEffect(() => {
        ...
        setChartSubmissionSetting(buildSubmissionProfileGraph(profileData, isAll));
        setChartReviewerSetting(buildReviewerProfileGraph(profileData, isAll));
    }, [profileData]);
